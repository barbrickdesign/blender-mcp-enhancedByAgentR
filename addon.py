...
bl_info = {
    ...
    "description": "Connect Blender to AI assistants via MCP (Claude, GitHub Copilot, Cursor, etc.)",
    "category": "Interface",
}
            ...
            if not bpy.context.scene.blendermcp_hyper3d_api_key:
                return {
                    ...
                    "message": """Hyper3D Rodin integration is currently enabled, but API key is not given. To enable it:
                                ...
                                4. Restart the MCP server connection"""
                }
...
class BLENDERMCP_OT_StartServer(bpy.types.Operator):
    ...
    bl_label = "Connect to MCP AI"
    bl_description = "Start the BlenderMCP server to connect with an MCP AI assistant"
...
class BLENDERMCP_OT_StopServer(bpy.types.Operator):
    ...
    bl_label = "Stop the MCP AI connection"
    bl_description = "Stop the MCP AI connection"
